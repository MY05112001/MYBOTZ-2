    ...
    try {
      ...
      try {
        ...
        if (settings) {
          ...
          if (!'owners' in settings) settings.owners = ['6289691512285']
          if (!'link' in settings) settings.link = 'https://chat.whatsapp.com/FgIZUPXN5Li9JlEU5xWDiV'
          ...
          owners: ['6289691512285'],
          link: 'https://chat.whatsapp.com/FgIZUPXN5Li9JlEU5xWDiV',
      ...
      if (opts['gconly'] && !m.fromMe && !m.chat.endsWith('g.us') && !global.db.data.users[m.sender].premium) return this.sendMessageModify(m.chat, `Akses Bot Ke Private Chat Di Tolak, Upgrade Premium Hanya Rp 10.000 Agar Bisa Bebas Akses Bot Dengan Hubungi Owner : @${owner[0]}\n\nJoin Ke Group Official Bot Untuk Free Akses & Informasi Kedepannya Tentang Bot, Klik tombol Di Bawah!`, m, { largeThumb: true, url: db.data.settings[conn.user.jid].link })
      ...
      for (let name in global.plugins) {
        ...
        if ((usedPrefix = (match[0] || '')[0])) {
          ...
          if (plugin.register == true && _user.registered == false) { // Butuh daftar?
            ...
            this.sendFooter(m.chat, status.register, "Bagaimana caranya??, Contoh: *.reg Muhammad Yahya.22*", m)
            continue
          }
          ...
          if (!isPrems && plugin.limit && db.data.users[m.sender].limit < plugin.limit * 1) {
            this.reply(m.chat, `Limit kamu sudah mencapai batas, silakan beli dengan cara *${usedPrefix}buy* atau kalau mau gratis tinggal ketik *.claim*`, m)
...
this.sendFile(id, action === 'add' ? wul : law, 'pp.jpg', text, null, false, { mentions: [user] })*/
              this.sendMessage(id, {
                  ...
                  externalAdReply: {
                     ...
                     thumbnailUrl: pp,
                     sourceUrl: "https://chat.whatsapp.com/FgIZUPXN5Li9JlEU5xWDiV",
                     mediaType: 1,
